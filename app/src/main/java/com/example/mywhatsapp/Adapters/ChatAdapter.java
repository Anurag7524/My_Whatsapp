...
//Chat adapter.viewHolder not used in this line because there are two view holders.
//For that, another method of item type has to be created inside the class.
public class ChatAdapter extends RecyclerView.Adapter{
    ...
    //Method to handle the two types of view(sender and receiver)
    @Override
    ...
    //Two view holders for two layouts(one for sender and other for receiver).
